...
def solve_part_2(signal):
    ...
    index = int(corrected_signal[0:7])
    return corrected_signal[index : index + 8]
...
class TestSolvePart2:
    def test_normal_2(self):
        assert solve_part_2("03036732577212944063491565474664") == "84462026"
