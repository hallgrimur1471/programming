...
def search_for_ball(acc_map, bar_width, bar_height):
    ...
    num_steps = right
    step = max(1, floor((right - left) / num_steps))
    cursor = left
    lens = {
        "left": cursor,
        "top": 0,
...
def test():
    ...
    with mss.mss() as screen:
        ...
        # bar = {"left": 60, "top": 860, "width": 205 + (635 - 60), "height": 200}
        # bar = {"left": 60, "top": 950, "width": 205 + (635 - 60), "height": 50}
